...
public class GoogleMail {
    ...
    */ 
    	...
    	// 제목 설정
    	String subject = "Medinfora 회원님의 아이디를 찾기위한 인증코드 발송";
	...
	public void sendmail_withFile(Map<String, Object> paraMap) throws Exception {
    	...
    	// 2. SMTP 서버의 계정 설정
   	    //    Google Gmail 과 연결할 경우 Gmail 의 email 주소를 지정 
    	prop.put("mail.smtp.user", "yhuhhjnnb@gmail.com");
    	...
    	// 보내는 사람의 메일주소
    	String sender = "yhuhhjnnb@gmail.com";
    	Address fromAddr = new InternetAddress(sender);
    	msg.setFrom(fromAddr);
	...
	/// #248.  Spring Scheduler(스프링스케줄러 05)는 서비스단에서 작업을 하는 것이다 
	...
	public void sendEmail(String recipient, String subject, String content) throws MessagingException {
	        ...
	        String user = "yhuhhjnnb@gmail.com";  // 구글 이메일 계정
	        String password = "your-email-password"; // 구글 이메일 비밀번호
