...
%>
<link rel="stylesheet" type="text/css" href="<%= ctxPath%>/resources/css/mypage/mypost.css" />
<script type="text/javascript" src="<%= ctxPath%>/resources/js/mypage/mypost.js"></script>

<div class="container" style="margin-top: 100px;">
    <div class="py-4" align="center">
        <h2 class="nanum-eb size-n">내가 작성한 글 목록</h2>
    </div>
    <form name="commuList">
