...
<div class="statusContainer mx-5">
	<div class="row row-cols-sm-3 g-4 m-5">
		<a href="<%=ctxPath%>/status/serviceUtilization.bibo">
			<div class="col">
		    	<div class="status_card card">
		    		<div>
		      			<img src="<%=ctxPath %>/resources/img/sh_hospital.png" class="card-img-top p-5" />
		      		</div>
		      		<div class="card-body">
	  	...
	  	<a href="<%=ctxPath%>/status/facilities.bibo">
		  	<div class="col">
		    	<div class="status_card card">
		      		...
		      		<div class="card-body">
		        		<h5 class="card-title text-center nanum-b">시도별 일반입원실 시설 현황</h5>
		      		</div>
		    	</div>
		  	</div>
	  	</a>
