...
function loginWithKakao(){
	...
	const url = "https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=${requestScope.kakaoApiKey}&redirect_uri=http://localhost:9099/${requestScope.RedirectUri}";
